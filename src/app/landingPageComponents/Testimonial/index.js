    ...
    <div className='container-fluid py-5'>
      <div className='container'>
        <div className='text-center mx-auto mb-5' style={{ maxWidth: '500px' }}>
          ...
          <h1 className='display-5'>Patients Say About Our Services</h1>
        </div>
            ...
            <div className='owl-carousel testimonial-carousel'>
              <div className='testimonial-item text-center'>
                ...
                <p className='fs-4 fw-normal'>
                  Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore lorem ipsum. At lorem lorem
                  magna ut et, nonumy et labore et tempor diam tempor erat. Erat dolor rebum sit ipsum.
                </p>
